...
namespace SIGLATAPI.Migrations
{
    ...
    [Migration("20250830160513_AddAttemptedEmailToLoginTracking")]
    partial class AddAttemptedEmailToLoginTracking
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Craftmatrix.org.API.Models.RoleDto", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 8, 30, 16, 5, 12, 650, DateTimeKind.Utc).AddTicks(7358),
                            Description = "System Administrator",
                            Name = "Admin",
                            UpdatedAt = new DateTime(2025, 8, 30, 16, 5, 12, 650, DateTimeKind.Utc).AddTicks(7359)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 8, 30, 16, 5, 12, 650, DateTimeKind.Utc).AddTicks(7363),
                            Description = "Regular User",
                            Name = "User",
                            UpdatedAt = new DateTime(2025, 8, 30, 16, 5, 12, 650, DateTimeKind.Utc).AddTicks(7363)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 8, 30, 16, 5, 12, 650, DateTimeKind.Utc).AddTicks(7364),
                            Description = "Ambulance Personnel",
                            Name = "Ambulance",
                            UpdatedAt = new DateTime(2025, 8, 30, 16, 5, 12, 650, DateTimeKind.Utc).AddTicks(7365)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 8, 30, 16, 5, 12, 650, DateTimeKind.Utc).AddTicks(7366),
                            Description = "Philippine National Police",
                            Name = "PNP",
                            UpdatedAt = new DateTime(2025, 8, 30, 16, 5, 12, 650, DateTimeKind.Utc).AddTicks(7366)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2025, 8, 30, 16, 5, 12, 650, DateTimeKind.Utc).AddTicks(7367),
                            Description = "Bureau of Fire Protection",
                            Name = "BFP",
                            UpdatedAt = new DateTime(2025, 8, 30, 16, 5, 12, 650, DateTimeKind.Utc).AddTicks(7368)
                        });
                });
